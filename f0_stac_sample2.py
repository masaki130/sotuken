# 低；0、高；1
# 特徴量とアクセントを統合したデータ
# re_f0_stac_result_5000に保存
# 各音節における統計値とaccentを保存
# 実行：python f0_stac_sample1.py --num_files 3
...
def main(args):
    ...
    csv_dir = 're_f0_stac_result_5000'
    ...
    accent_filepath = 'jsut_accent_onsoretu/onsoretu_re_split.csv'
    ...
    for i, alignment_file in enumerate(alignment_files):
        ...
        statistics = savefig(f'{result_dir}/f0_heikin_result_{i+1}.png', f0, new_frame_period, alignment, accents)
        
        # Save the statistics to a CSV file
        save_statistics_csv(f'{csv_dir}/re_f0_statistics_{i+1}.csv', statistics)
